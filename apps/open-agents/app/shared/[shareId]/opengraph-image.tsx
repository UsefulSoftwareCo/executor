...
import { getChatById, getEveChatEventRows } from "@/lib/db/sessions";
import {
...
export default async function Image({
  ...
  const [ownerResult, eventRows] = await Promise.all([
    db
      .select({
  ...
  const messageCount = toWebAgentMessagesFromEventRows(eventRows).length;
