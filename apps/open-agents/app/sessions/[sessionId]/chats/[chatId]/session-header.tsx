          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button asChild variant="ghost" size="icon" className="h-7 w-7">
                <Link href={`/sessions/${session.id}/executor`}>
                  <Wrench className="h-4 w-4" />
                </Link>
              </Button>
            </TooltipTrigger>
            <TooltipContent side="bottom">Session tools</TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <Button asChild variant="ghost" size="icon" className="h-7 w-7">
                <Link href={`/sessions/automations?sessionId=${encodeURIComponent(session.id)}`}>
                  <Workflow className="h-4 w-4" />
                </Link>
              </Button>
            </TooltipTrigger>
            <TooltipContent side="bottom">Attached automations</TooltipContent>
          </Tooltip>
