...
const sessions: readonly FakeSession[] = [
  ...
  {
    title: "Eve persistence",
    repo: "open-agents",
    branch: "feat/eve-persistence",
    prompt: "Persist chat sessions through the Eve browser runtime",
    summary:
      "Moved chat turns through the Eve runtime, persisted stream events, and verified browser session restore.",
    toolCount: 8,
    todoTotal: 3,
    todoDone: 3,
    elapsed: "1m 18s",
    files: [
      "app/sessions/[sessionId]/chats/[chatId]/hooks/use-session-chat-runtime.ts",
      "app/api/sessions/[sessionId]/chats/[chatId]/eve/route.ts",
    ],
  },
  {
    title: "Fix tests",
