...
const tools = [
  ...
  { name: "read_file", detail: "lib/session.ts" },
  { name: "write_file", detail: "app/api/auth/route.ts" },
  { name: "write_file", detail: "app/api/auth/callback/route.ts" },
  { name: "glob", detail: "app/**/middleware.ts" },
