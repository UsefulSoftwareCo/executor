...
const scenes: readonly Scene[] = [
  ...
  },
  {
    name: "sandbox",
    data: [
      { tone: "muted", text: "> persist chat sessions through Eve" },
      { tone: "dim", text: "sandbox: vercel (feat/eve-persistence)" },
      { tone: "plain", text: "" },
      {
        tone: "ok",
        text: "reading app/sessions/[sessionId]/chats/[chatId]/hooks/use-session-chat-runtime.ts",
      },
      {
        tone: "ok",
        text: "reading app/api/sessions/[sessionId]/chats/[chatId]/eve/route.ts",
      },
      { tone: "ok", text: "editing use-session-chat-runtime.ts - queue events" },
      { tone: "ok", text: "editing eve/route.ts - store session state" },
      { tone: "ok", text: "running bun run ci" },
      { tone: "plain", text: "" },
      { tone: "plain", text: "wired Eve browser-session persistence." },
      {
        tone: "dim",
        text: "  +18 -9 app/sessions/[sessionId]/chats/[chatId]/hooks/use-session-chat-runtime.ts",
      },
      {
        tone: "dim",
        text: "  +10 -4 app/api/sessions/[sessionId]/chats/[chatId]/eve/route.ts",
      },
      { tone: "ok", text: "auto-commit: WIP: persist chats with Eve" },
      { tone: "ok", text: "pushed to origin/feat/eve-persistence" },
    ],
  },
  {
    name: "subagent",
