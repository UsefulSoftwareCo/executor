...
```
            ...
            │          ▼          ▼                               │
            │  ┌──────────┐  ┌──────────────┐    ┌────────────┐  │
            │  │Eve turn  │  │  hibernating  │───▶│ hibernated │  │
...
| `lib/sandbox/lifecycle-kick.ts`                                       | Workflow kick and lease claiming             |
...
| `app/sessions/[sessionId]/chats/[chatId]/hooks/use-session-chat-runtime.ts` | Browser-session runtime and activity refresh |
| `app/api/sessions/[sessionId]/chats/[chatId]/eve/route.ts`            | Eve stream event and session persistence     |
