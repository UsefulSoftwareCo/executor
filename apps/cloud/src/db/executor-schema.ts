import { pgTable, varchar, text, json, bigint, boolean, timestamp, uniqueIndex } from "drizzle-orm/pg-core"
...
export const integration = pgTable("integration", {
  ...
  uniqueIndex("integration_uidx").on(table.tenant, table.slug)
])
...
export const subject = pgTable("subject", {
  ...
  uniqueIndex("subject_uidx").on(table.tenant, table.external_id)
])
...
export const connection = pgTable("connection", {
  ...
  uniqueIndex("connection_uidx").on(table.tenant, table.owner, table.subject, table.integration, table.name)
])
...
export const oauth_session = pgTable("oauth_session", {
...
export const tool = pgTable("tool", {
  ...
  uniqueIndex("tool_uidx").on(table.tenant, table.owner, table.subject, table.integration, table.connection, table.name)
])
...
export const definition = pgTable("definition", {
  ...
  uniqueIndex("definition_uidx").on(table.tenant, table.owner, table.subject, table.integration, table.connection, table.name)
])
...
export const artifact = pgTable("artifact", {
  ...
  uniqueIndex("artifact_uidx").on(table.tenant, table.owner, table.subject, table.id)
])
...
export const plugin_storage = pgTable("plugin_storage", {
  ...
  uniqueIndex("plugin_storage_uidx").on(table.tenant, table.owner, table.subject, table.plugin_id, table.collection, table.key)
])
