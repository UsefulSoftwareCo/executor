...
//
// The marketing site is static, so this runs once during the build. To keep
// that build resilient we:
...
//   - hint compatible fetch hosts to edge-cache the upstream response;
