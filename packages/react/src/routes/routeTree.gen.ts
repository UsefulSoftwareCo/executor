...
import { Route as DotCredentialsRouteImport } from './credentials'
...
const DotCredentialsRoute = DotCredentialsRouteImport.update({
...
export interface FileRoutesByFullPath {
  '/{-$orgSlug}/credentials': typeof DotCredentialsRoute
...
export interface RootRouteChildren {
  DotCredentialsRoute: typeof DotCredentialsRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/{-$orgSlug}/credentials': {
      ...
      preLoaderRoute: typeof DotCredentialsRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/{-$orgSlug}/toolkits/$toolkitSlug': {
...
const rootRouteChildren: RootRouteChildren = {
  DotCredentialsRoute: DotCredentialsRoute,
