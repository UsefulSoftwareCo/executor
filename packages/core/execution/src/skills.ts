...
const ARTIFACT_STYLE_SKILL_BODY = [
  ...
  '- Wrap in `<ResponsiveContainer width="100%" height={240}>`; never a fixed pixel width.',
  "",
  "## Numbers",
  "",
  ...
  "- `position: fixed` or `position: sticky` — you are in a frame the host resizes; fixed elements detach and float over the console.",
  "- A nested scroll container (`overflow-y-auto` with a fixed height). The frame grows to your content and the host scrolls; an inner scrollbar traps the user's wheel.",
  "- `100vh` / `100vw` sizing, for the same reason. Size to content.",
