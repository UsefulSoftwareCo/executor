...
export interface VercelSandboxConfig {
  ...
  /**
   * Optional GitHub repositories to clone into subdirectories of the sandbox.
   * Use this for metarepo-style workspaces where the agent needs to inspect
   * and potentially edit related services side-by-side.
   */
  sources?: Array<{
    /** GitHub repository URL (e.g., "https://github.com/owner/repo") */
    url: string;
    ...
    branch?: string;
    /**
     * Directory name or relative path under the workspace.
