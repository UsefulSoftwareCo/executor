...
export default defineConfig({
  test: {
    projects: [
      ...
      // Opt-in deployment cycles against hosted OAuth providers: the attached
      // Docker instance needs a public HTTPS URL for real CIMD document fetches.
      project("selfhost-docker-cimd", {
        include: ["selfhost-docker/oauth-cimd-deployment.test.ts"],
